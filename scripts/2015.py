...
if __name__ == '__main__':
    print('2015 Data Processing running...')
    start = time.time()
    # init global vars
    # test data path
    # DATA_PATH = '../test'
    ...
    for day in dates:
        ...
        # generate daily data
        print(day + ' running...')
        with open(DATA_PATH + '/TaxiData/2015/' + day + '.txt', 'r', encoding='gbk') as fp:
