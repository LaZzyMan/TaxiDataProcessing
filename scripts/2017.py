...
File Format:
> yyyymmdd.tar.gz
> > yyyymmdd/data/home/apihadoop/yyyymmdd/
> > > yyyymmdd.txt
...
if __name__ == '__main__':
    print('2017 Data Processing running...')
    start = time.time()
    # init global vars
    # test data path
    # DATA_PATH = '../test'
    ...
    for day in dates:
        ...
        # generate daily data
        print(day + ' running...')
        if os.path.exists(DATA_PATH + '/TaxiData/2017/' + day):
            shutil.rmtree(DATA_PATH + '/TaxiData/2017/' + day)
        print('Unzip file...')
        with open(Unzip.un_tar_gz(DATA_PATH + '/TaxiData/2017/' + day + '.tar.gz') + '/data/home/apihadoop/'
                  + day + '/' + day + '.txt', 'r') as fp:
